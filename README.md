...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/fastdownload-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/fastdownload-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add fastdownload
# for installing globally
pixi global install fastdownload
```
...
It is possible to list all of the versions of `fastdownload` available on your platform:
...
```
pixi search fastdownload --channel conda-forge
```
